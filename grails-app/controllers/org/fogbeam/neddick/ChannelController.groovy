...
class ChannelController 
{
	...
	def save()
	{	
		log.debug "channel save params: ${params}";
		...
		*/
		...
		// log.debug "aggregateChannels: ${aggregateChannelsToAdd}";
	...
	def edit()
	{
		...
		if( channelName )
		{
			...
			if( theChannel )
			{
				log.debug "located channel: ${theChannel.id}";
			...
			{
				log.debug "Could not locate channel: ${channelName}";
			}
		...
		// log.debug "Found ${availableFeeds.size()} available feeds";
		...
		log.debug "Found ${availableDatasources.size()} available datasources";
